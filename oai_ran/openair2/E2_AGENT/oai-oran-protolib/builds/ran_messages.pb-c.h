...
struct  UeInfoM
{
  ...
  int32_t nssai_sd;
  protobuf_c_boolean has_wb_cqi_1tb;
  int32_t wb_cqi_1tb;
  protobuf_c_boolean has_wb_cqi_2tb;
  int32_t wb_cqi_2tb;
  protobuf_c_boolean has_dl_total_window;
  uint32_t dl_total_window;
  protobuf_c_boolean has_dl_errors_window;
  uint32_t dl_errors_window;
  protobuf_c_boolean has_dl_bler_window;
  float dl_bler_window;
  protobuf_c_boolean has_dl_thr_window;
  float dl_thr_window;
};
